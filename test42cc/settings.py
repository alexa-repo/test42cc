...
DATABASES = {
    'default': {
        ...
        'NAME': 'accountdb2', # Or path to database file if using sqlite3.
...
SECRET_KEY = 'vj7medpba*4ht*y4e&54)cxqooqu)v=0_d6ku3910hc6^bh6nx'
...
MIDDLEWARE_CLASSES = (
    ...
    'test42cc.src.middleware.HttpStoredQueryMiddleware',
