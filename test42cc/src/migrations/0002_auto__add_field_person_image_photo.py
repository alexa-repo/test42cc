...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.image_photo'
        db.add_column(u'src_person', 'image_photo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.image_photo'
        db.delete_column(u'src_person', 'image_photo')
    ...
    models = {
        ...
        u'src.httpstoredquery': {
            ...
            'date_with_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 21, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
