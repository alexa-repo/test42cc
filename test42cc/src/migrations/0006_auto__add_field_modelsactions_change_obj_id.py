...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModelsActions.change_obj_id'
        db.add_column(u'src_modelsactions', 'change_obj_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ModelsActions.change_obj_id'
        db.delete_column(u'src_modelsactions', 'change_obj_id')
    ...
    models = {
        ...
        u'src.modelsactions': {
            ...
            'change_obj_id': ('django.db.models.fields.IntegerField', [], {}),
