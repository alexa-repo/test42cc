...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HttpStoredQuery.priority'
        db.add_column(u'src_httpstoredquery', 'priority',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HttpStoredQuery.priority'
        db.delete_column(u'src_httpstoredquery', 'priority')
    ...
    models = {
        ...
        u'src.httpstoredquery': {
            ...
            'date_with_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 28, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
