...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ModelsActions.change_obj_id'
        db.alter_column(u'src_modelsactions', 'change_obj_id', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'ModelsActions.change_obj_id'
        db.alter_column(u'src_modelsactions', 'change_obj_id', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'src.httpstoredquery': {
            ...
            'date_with_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 30, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'src.modelsactions': {
            ...
            'change_obj_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
